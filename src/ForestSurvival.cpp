...
//    }
    ...
    // Create tree
    trees.push_back(
        std::make_unique<TreeSurvival>(child_nodeIDs, split_varIDs, split_values, split_types, split_multvarIDs, split_directs, split_multvalues, chf, &unique_timepoints,
